...
public class AttendanceService extends GenericService<Attendance, Integer> implements IAttendanceService {
    ...
    @Override
    public Map<String, Long> getStudentAttendanceStats(Integer studentId, Integer classroomId) {
        return repo.getStudentAttendanceStatsInClassroom(studentId, classroomId);
    }
